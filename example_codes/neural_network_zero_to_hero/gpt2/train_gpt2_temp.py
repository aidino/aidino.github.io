...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        # kỹ thuật tối ưu hóa gọi là weight tying (chia sẻ trọng số)
...
text_path = '/home/dino/Documents/aidino.github.io/example_codes/neural_network_zero_to_hero/gpt_from_scratch/than_dieu_dai_hiep.txt'
