...
Multimodel input design pattern giải quyết vấn đề biểu diễn các loại dữ liệu hoặc dữ liệu khác nhau có thể được biểu thị theo những cách phức tạp
bằng cách ghép nối tất cả các biểu diễn dữ liệu có sẵn.  
...
![](resources\multimodel-input-1.png)
