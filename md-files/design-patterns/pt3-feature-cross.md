...
Feature Cross design pattern giúp các mô hình tìm hiểu mối quan hệ giữa các yếu tố đầu vào nhanh hơn bằng cách làm cho mỗi kết hợp giá trị đầu vào trở thành một tính năng riêng biệt một cách rõ ràng.  

#### Problem

Xem xét tập dữ liệu trong Hình 2-14 và nhiệm vụ tạo bộ phân loại nhị phân phân tách các nhãn `+` và ` -  `

<img src="resources\feature-cross-1.png" alt="feature-cross-1" style="zoom:100%;" />
